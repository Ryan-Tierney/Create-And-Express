...
import { deleteComment, setFormDataForEditComment, resetFormDataForComment } from '../actions/creations'
    ...
    render(){
        ...
        return (
            <div className='comment'>
                ...
                <span>
                    <span>
                        <a href="#bottom" onClick={this.onClickOfEdit}> Edit </a>
                    </span>
                    <span>
                        <a href="#bottom" onClick={this.onClick}>Delete</a>
                    </span>
                </span>

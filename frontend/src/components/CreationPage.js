...
class CreationPage extends Component {
    ...
    render() {
        const { name, image, category, location, date, notes, comments, id, username } = this.props
        return (
            <>
            ...
            <div className='info'>
                <p>
                    <span className='creation-page-info u-margin-top-medium' >Created by { username } 
                    :
                    </span>
                </p>
                <p>
                    <span className='creation-page-info u-margin-top-small'>City: {location.city} </span>
                </p>
                <p>
                    <span className='creation-page-info u-margin-top-small'>Country: {location.country} </span>
                </p>
                <p>
                    <span className='creation-page-info u-margin-top-small'>published on: { date } </span>
                </p>
            ...
            <div className='comment-container'>
                ...
                <h4 className='creations-page-info'>Add Comment:</h4>{ this.props.currentUser.id && <CommentForm creation_id={ id } />}
            </div>
            </>
        )
    }
...
export default connect(mapStateToProps, { setSelectedCreation, unsetCreation })(CreationPage)